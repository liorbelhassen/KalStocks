...
"${text}"
משימתך: אמת כל טענה עובדתית מול חדשות עדכניות ואמיתיות (חפש ברשת עכשיו). היזהר במיוחד מהזיות — אירועים שלא קרו (למשל "ירי רקטות"/"מתקפה" כשלא אירעו), נתונים שגויים, או ייחוס סיבה לא נכונה.
